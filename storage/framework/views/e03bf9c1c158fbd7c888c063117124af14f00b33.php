        ...
        <div class="companyList_wrap">
            ...
            <div class="companies">
                ...
                <?php if(!$companies->isEmpty()): ?>
                    ...
                    <div class="col-md-4">
                        <a  href="<?php echo e(route('diagnosis.futureSingleCompany',['id'=>$company->id])); ?>"><img class="company_logo primary_border" src="/storage/images/<?php echo e($company->company_icon); ?>" alt=""></a>
