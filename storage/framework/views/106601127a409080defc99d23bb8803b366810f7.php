            ...
            <div class="companies">
                <div class="row">
                    <?php if(!$companies->isEmpty()): ?>
                        ...
                        <div class="col-md-4">
                            <a  href="<?php echo e(route('diagnosis.selfSingleCompany',['id'=>$company->id])); ?>"><img class="company_logo primary_border" src="http://s-ryota.sakura.ne.jp/futureMind/storage/images/<?php echo e($company->company_icon); ?>" alt=""></a>
