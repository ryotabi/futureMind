<?php $__env->startSection('content'); ?>
    <main>
        <div class="singleCompany_wrap">
            <div class="singleCompany_title future_color"><?php echo e($company->name); ?></div>
            <div class="singleCompany_content">
                <div class="container">
                    ...
                    <form method="POST" action="<?php echo e(route('diagnosis.futureLikeCompany',['id'=>$company->id])); ?>" class="likes_btn_wrap text-center">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\futureMind\resources\views/diagnosis/futureSingleCompany.blade.php ENDPATH**/ ?>