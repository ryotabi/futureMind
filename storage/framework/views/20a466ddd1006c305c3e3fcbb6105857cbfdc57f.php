                ...
                <h3 class="diagnosis_title future_title">理想分析</h3>
                    <div class="questions_wrap">
                        ...
                        <div id="submit" class="question_wrap hidden">
                            <form action="<?php echo e(route('diagnosis.futurePost')); ?>" method="post" class="text-center">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\futureMind\resources\views/diagnosis/future.blade.php ENDPATH**/ ?>