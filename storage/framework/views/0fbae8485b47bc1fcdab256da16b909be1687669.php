        ...
        <div class="companyList_wrap">
            ...
            <div class="companies">
                ...
                <?php if(!$likeUsers->isEmpty()): ?>
                    ...
                    <div class="col-md-4">
                        <a  href="<?php echo e(route('company.singleStudent',['id'=>$user->id])); ?>"><img class="company_logo primary_border" src="http://s-ryota.sakura.ne.jp/futureMind/storage/images/<?php echo e($user->img_name); ?>" alt=""></a>
