<?php $__env->startSection('content'); ?>
    ...
    <div class="chat_wrap">
            ...
            <h3 class="chat_title">チャット</h3>
                <div class="row">
                    <div class="col-md-3">
                        <div class="text-center">
                            <p class="chat_name"><?php echo e($student_user->name); ?></p>
                    ...
                    <div class="col-md-6">
                        <div class="message_wrap message_wrap_company">
                            ...
                            <?php if($message->company_user !== 0): ?>
                            <div class="text-right">
                                <div class="balloon1-right">
                                    <p><?php echo e($message->message); ?></p>
                                </div>
                            </div>
                            <?php elseif($message->company_user === 0): ?>
                            <div>
                ...
                <form action="<?php echo e(route('company.postMessage',['id'=>$room_id])); ?>" method="POST" class="chat_form_wrap">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.company_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\futureMind\resources\views/Company/chat.blade.php ENDPATH**/ ?>