            ...
            <div class="container">
                ...
                <div class="questions_wrap">
                    ...
                    <div id="submit" class="question_wrap hidden">
                            <form action="<?php echo e(route('company.diagnosisPost')); ?>" method="post" class="text-center">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.company_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\futureMind\resources\views/Company/diagnosis.blade.php ENDPATH**/ ?>