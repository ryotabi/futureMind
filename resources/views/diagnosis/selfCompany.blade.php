            ...
            <div class="companies">
                <div class="row">
                    @if(!$companies->isEmpty())
                        ...
                        <div class="col-md-4">
                            <a  href="{{route('diagnosis.selfSingleCompany',['id'=>$company->id])}}"><img class="company_logo primary_border" src="http://s-ryota.sakura.ne.jp/futureMind/storage/images/{{$company->company_icon}}" alt=""></a>
