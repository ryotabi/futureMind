        ...
        <div class="companyList_wrap">
            ...
            <div class="companies">
                ...
                @if(!$companies->isEmpty())
                    ...
                    <div class="col-md-4">
                        <a  href="{{route('diagnosis.futureSingleCompany',['id'=>$company->id])}}"><img class="company_logo primary_border" src="/storage/app/public/images/{{$company->company_icon}}" alt=""></a>
