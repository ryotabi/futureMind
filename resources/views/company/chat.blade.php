                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="text-center chat_user">
                            ...
                            <img class="chat_img" src="http://s-ryota.sakura.ne.jp/futureMind/storage/images/{{$student_user->img_name}}" alt="画像">
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-3 auth_profile">
                        <div class="text-center chat_user">
                            ...
                            <img class="chat_img" src="http://s-ryota.sakura.ne.jp/futureMind/storage/images/{{$company_user->company_icon}}" alt="画像">
                        </div>
                    </div>
                </div>
                <form action="{{route('company.postMessage',['id'=>$room_id])}}" method="POST" class="chat_form_wrap">
                    @csrf
