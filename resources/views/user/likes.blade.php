        ...
        <div class="companyList_wrap">
            ...
            <div class="companies">
                ...
                @if(!$likeCompanies->isEmpty())
                    ...
                    <div class="col-md-4">
                        <a  href="{{route('search.single',['id'=>$company->id])}}"><img class="company_logo primary_border" src="http://s-ryota.sakura.ne.jp/futureMind/storage/images/{{$company->company_icon}}" alt=""></a>
